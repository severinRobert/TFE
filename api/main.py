...
from routers import fields, products, product_fields, types, users, selections, selections_groups, sites, states, roles, offers
import os
...
app.include_router(selections_groups.router)
